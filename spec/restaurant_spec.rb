...
RSpec.describe Restaurant do
  ...
  describe "Iteration 2" do
    ...
    it "has closing time" do
      ...
      expect(restaurant1.closing_time(8)).to eq(8)
      expect(restaurant2.closing_time(7)).to eq(7)
    end
    ...
    describe "Iteration 3" do
      ...
      it "menu_dish_names" do
        restaurant = Restaurant.new('16:00', 'Il Poggio')
        restaurant.menu_dish_names('Burrata')
        restaurant.menu_dish_names('Pizzetta')
        restaurant.menu_dish_names('Ravioli')
