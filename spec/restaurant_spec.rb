...
RSpec.describe Restaurant do
  ...
  describe 'Iteration 4' do
    ...
    it 'can announce closing times for restaurant 1' do
    ...
    it 'can announce closing times for multiple restaurants' do
      restaurant2 = Restaurant.new('16:00', 'Il Posto')
